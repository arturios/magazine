...
<ul>
<li class="facebook">
<a href='http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&t=<?php the_title(); ?>' class="icon-facebook-square" title="Compartir en facebook" target="_blank">Facebook</a>
</li>
<li class="twitter">
<a href="http://twitter.com/home?status=Leyendo%20este%20post%20<?php the_permalink(); ?>" target="_blank" title="Enviar a Twitter" class="icon-twitter">Twitter</a>
</li>
<li class="google">
